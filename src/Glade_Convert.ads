...
package Glade_Convert is
   ...
   package Propertie is new Buffer(Prop_Item);
   package Delta_Buf is new Buffer(Line_nrs);
   ...
   package Pipe_With is new Pipe(Unbounded_String, Empty_String);
   ...
   Spacing             : integer;
   Default_Spacing     : constant integer := 0;
   Orientation         : Unbounded_String;
   Default_Orientation : constant Unbounded_String := To_Unbounded_String("vertical");
   ...
   Item_Names     : constant array(first_item .. last_Item, 1 .. 2 ) of Unbounded_String :=
     ((To_Unbounded_String("GtkWindow"),To_Unbounded_String("Gtk_Window")),
      ...
      (To_Unbounded_String("GtkStatusbar"),To_Unbounded_String("Gtk_Status_Bar")),
   ...
   function Make_With(Name : Unbounded_String; Ext : String) return Unbounded_String;
   ...
   procedure Start_Body(Name   : Unbounded_String;
                        str    : String;
                        Buffer : Gtk_Text_Buffer);
   procedure Insert_End_Spec(Name : Unbounded_String; Win : Items);
