...
with Glade2Ada_Languages_Dialog_CB; use Glade2Ada_Languages_Dialog_CB;

package body Glade2Ada_Languages is
   ...
   begin
      ...
      Glade_Name_Init.Main_Dialog.Set_Title (To_String(Lan_Dialog_Title(Lan)));
      -- Menu Items
      ...
      -- Glade2Ada_Main Dialog
      Glade_Name_Init.Main_Dialog.OK.Set_Label(To_String(Lan_OK(Lan)));
      Glade_Name_Init.Main_Dialog.Cancel.Set_Label(To_String(Lan_Cancel(Lan)));
      -- Language Dialog
